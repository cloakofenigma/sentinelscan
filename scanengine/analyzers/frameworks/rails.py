"""Ruby on Rails Framework Analyzer - Stub."""
...
@AnalyzerRegistry.register_framework('rails')
class RailsAnalyzer(FrameworkAnalyzer):
    @property
    def name(self) -> str: return "rails_analyzer"
    @property
    def framework_name(self) -> str: return "Rails"
    @property
    def base_language(self) -> str: return "ruby"
    @property
    def supported_extensions(self) -> Set[str]: return {'.rb', '.erb'}
    @property
    def framework_extensions(self) -> Set[str]: return {'.rb', '.erb'}
    @property
    def detection_patterns(self) -> List[str]: return ['file:Gemfile', 'content:rails']
    @property
    ...
    def is_framework_project(self, files: List[Path], content_cache: Dict[str, str]) -> bool:
        for f in files:
            if f.name == 'Gemfile':
                ...
                if "'rails'" in content or '"rails"' in content: return True
        return False
